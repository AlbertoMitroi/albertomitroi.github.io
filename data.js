window.cvData = {
  ...
  aboutHighlights: [
    ...
    "Azure OpenAI, RAG and AI agents"
  ],
  focusAreas: [
    { title: "Full-Stack Product Delivery", text: "React, Next.js, TypeScript and Angular interfaces connected to ASP.NET Core APIs and relational data." },
